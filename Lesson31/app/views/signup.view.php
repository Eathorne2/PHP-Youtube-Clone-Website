...
<div class="form-container">
  ...
  <form  method="POST">
    ...
    <div class="col-md-12 mb-3">
      <label for="channel_name" class="form-label">Your Channel's Name</label>
      <input type="text" class="form-control" value="<?=oldValue('channel_name')?>" name="channel_name" id="channel_name" >
      <?=showError($errors,'channel_name')?>
    </div>
